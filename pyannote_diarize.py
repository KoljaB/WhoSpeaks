...
audio_file = "input/CoinToss.mp3"
exact_speakers = 2
min_speakers = 2
max_speakers = 2
output_directory = "output_pyannote"
...
def test_diarization():
    ...
    # Perform diarization
    speakers = diarize(audio_file, exact_speakers, min_speakers, max_speakers)

    # Write diarization results to files
    write_speaker_timefiles(speakers, output_directory)

    print("Diarization test completed. Check the 'output' directory for results.")
